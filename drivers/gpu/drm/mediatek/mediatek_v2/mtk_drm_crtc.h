...
int mtk_crtc_show_paper_texture(struct drm_crtc *crtc, bool enable,
	struct cmdq_pkt *crtc_cmdq_handle);
int mtk_crtc_restore_paper_texture(struct drm_crtc *crtc, bool enable,
 struct cmdq_pkt *crtc_cmdq_handle);
