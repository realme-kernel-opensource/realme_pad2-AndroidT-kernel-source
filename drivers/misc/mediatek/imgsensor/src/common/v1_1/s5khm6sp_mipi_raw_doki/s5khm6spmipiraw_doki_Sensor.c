...
#define PFX "S5KHM6SP_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KHM6SP_SENSOR_ID_DOKI,
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(addr_data_pair_init_hm6sp,
		sizeof(addr_data_pair_init_hm6sp) / sizeof(kal_uint16));
	LOG_INF("s5khm6sp--- X\n");
	LOG_INF("X");
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(addr_data_pair_pre_hm6sp,
			sizeof(addr_data_pair_pre_hm6sp) / sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(addr_data_pair_cap_hm6sp,
			sizeof(addr_data_pair_cap_hm6sp) / sizeof(kal_uint16));
...
{
	LOG_INF("E\n");
	table_write_cmos_sensor(addr_data_pair_video_hm6sp,
		sizeof(addr_data_pair_video_hm6sp) / sizeof(kal_uint16));
}

static void hs_video_setting(void)
{
	LOG_INF("E\n");
	table_write_cmos_sensor(addr_data_pair_hs_hm6sp,
			sizeof(addr_data_pair_hs_hm6sp) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
	LOG_INF("E\n");
	table_write_cmos_sensor(addr_data_pair_slim_hm6sp,
		sizeof(addr_data_pair_slim_hm6sp) / sizeof(kal_uint16));
}

static void custom1_setting(void)
{
	LOG_INF("E\n");
	table_write_cmos_sensor(addr_data_pair_cus1_hm6sp,
		sizeof(addr_data_pair_cus1_hm6sp) / sizeof(kal_uint16));
}

static void custom2_setting(void)
{
	LOG_INF("E\n");
	table_write_cmos_sensor(addr_data_pair_cus2_hm6sp,
		sizeof(addr_data_pair_cus2_hm6sp) / sizeof(kal_uint16));
}

static void custom3_setting(void)
{
	LOG_INF("E\n");
	table_write_cmos_sensor(addr_data_pair_cus3_hm6sp,
		sizeof(addr_data_pair_cus3_hm6sp) / sizeof(kal_uint16));
}

static void custom4_setting(void)
{
	LOG_INF("E\n");
	table_write_cmos_sensor(addr_data_pair_cus4_hm6sp,
		sizeof(addr_data_pair_cus4_hm6sp) / sizeof(kal_uint16));
}
